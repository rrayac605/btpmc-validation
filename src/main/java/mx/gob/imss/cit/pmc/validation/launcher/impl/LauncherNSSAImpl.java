...
import mx.gob.imss.cit.pmc.validation.rules.NSSARuleFactory;

@Component
public class LauncherNSSAImpl implements LauncherNSSA {

	@Autowired
	private NSSARuleFactory nSSARuleFactory;
	...
	public void validaRegistro(RegistroDTO registroDTO) {		
		...
		rulesEngine.fire(nSSARuleFactory.getRules(), facts);
