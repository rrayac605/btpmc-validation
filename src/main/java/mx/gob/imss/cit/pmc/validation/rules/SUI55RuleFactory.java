...
@Component
public class SUI55RuleFactory {

	private final static Logger logger = LoggerFactory.getLogger(SUI55RuleFactory.class);
	...
	public void creaReglas() {
		...
		try {
			rules = ruleFactory.createRules(new FileReader(parametrosService
					.obtenerParametro(ParametrosEnum.RUTA_VALIDACION_SUI55.getIdentificador()).getDesParametro()));
